...
class ProductScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    // Manejar el caso de que el producto sea nulo (ej. si el ID no existe o hubo un error).
    if (product == null) {
      return Scaffold(
        appBar: AppBar(title: const Text('Producto no encontrado')),
        body: const Center(
          child: Text('Error al cargar el producto o ID inválido.'),
        ),
      );
    }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            if (productState.products == null) return;
