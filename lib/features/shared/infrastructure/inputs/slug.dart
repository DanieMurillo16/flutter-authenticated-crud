...
class Slug extends FormzInput<String, SlugError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == SlugError.formt ) return 'El campo es no tiene el formato esperado';
  ...
  SlugError? validator(String value) {
    ...
    if ( value.contains(' ') || value.trim().isEmpty ) return SlugError.formt;
